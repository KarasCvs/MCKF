...
for target in targets:
    ...
    for i in range(3):
        plt.figure(i)
        plt.plot(timeline, mse[i], label=f"MCEKF, sigma={sigma}", linewidth=1, linestyle='-.')
        ...
        # plt.title(f'Mean-Square Error(MSE) of x{i+1} Under Gaussian Noise and Outliers', fontsize=20)
