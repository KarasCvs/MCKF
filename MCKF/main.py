...
eps = 1e-8
# testing parameters
additional_noise = 200*np.random.randn(obs_dimension, N)
...
# Plot
print(f'ukf_MSE =\n{ukf_MSE}\nmcukf_MSE =\n{mcukf_MSE}')
data_summarizes = {'System states': states, 'Sensor observation': sensor,
                   'Noise_free observation': real_obs, 'UKF states': mean_ukf_states,
                   'UKF MSE1': ukf_MSE_1, 'UKF MSE': ukf_MSE,
                   'Mcukf states': mean_mcukf_states, 'MCUKF MSE1': mcukf_MSE_1,
                   'MCUKF MSE': mcukf_MSE}
