...
A = np.matrix([0, 1, 0, 0]).reshape(x_dimension, x_dimension)
B = np.matrix([0, 1]).reshape(x_dimension, y_dimension)
C = np.matrix([1, 0]).reshape(y_dimension, x_dimension)
